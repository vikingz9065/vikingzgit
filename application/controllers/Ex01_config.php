...
// 3) 컨트롤러 클래스는 CI_Contoller를 반드시 승속받아야 함.


class Ex01_config extends CI_Controller
{

	/* 생성자. 클래스가 초기화 될 때 자동 실행됨. */
	public function __construct(){
		// 상위 클래스의 생성자 호출 --> CI 기본기능 초기화.
		parent::__construct();
	}


	/*
		도메인 / 컨트롤러클래스이름(소문자)/함수이름(소문자)
	...
	*/
	...
	/*
		...
		>> php index.php ex01_config/show_item
	*/
	...
	/*
		...
		>> php index.php ex01_config/custom_all
	*/
	...
	/*
		...
		>> php index.php ex01_config/custom_item
	*/
